...
export default class About extends Component {
  render() {
    return (
      <section>
        <h2>关于作者</h2>
        <p>我是<span className="highLight">要笑娟</span>。受母亲影响，从小接触<a className="highLight" href="https://zh.wikipedia.org/zh/%E5%9F%BA%E7%9D%A3%E6%95%99">基督教</a>，现在也是耶稣的忠实追随者即基督徒O(∩_∩)O。</p>
